...
export const metadata: Metadata = {
  ...
  description:
    "6개 질문에 답하면 당신에게 딱 맞는 원피스 카드 게임 덱을 추천해 드려요! 한국 OP-13 + EB-03 현행 메타와 OP-14 미리보기 반영.",
  openGraph: {
    title: "원피스 카드 게임 덱 추천",
    description: "6개 질문으로 한국 현행 메타와 OP-14 출시 예정 덱을 추천해 드려요!",
    locale: "ko_KR",
    type: "website",
  },
};
    ...
    <html lang="ko">
      <body className="flex min-h-screen flex-col bg-gray-50 antialiased">
        ...
        <footer className="border-t border-gray-200 bg-white py-4 text-center text-xs text-gray-400">
          <p>원피스 카드 게임 덱 추천 · 한국 OP-13 + EB-03 메타 기준</p>
